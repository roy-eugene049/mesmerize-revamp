  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => Promise.resolve().then(() => require("./FloatingTanStackRouterDevtools-DVpgfFhb.cjs")));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => Promise.resolve().then(() => require("./BaseTanStackRouterDevtoolsPanel-B1S3zWjv.cjs")).then((n) => n.BaseTanStackRouterDevtoolsPanel$1));
...
//# sourceMappingURL=index-DHlpHpaG.cjs.map
