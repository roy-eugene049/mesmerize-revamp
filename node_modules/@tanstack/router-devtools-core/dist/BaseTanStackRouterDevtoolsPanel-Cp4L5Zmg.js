import { a as createSignal, b as createEffect, g as createRenderEffect, u as useContext, S as ShadowDomTargetContext, k as delegateEvents, d as createMemo, t as template, i as insert, l as memo, e as createComponent, h as className, s as setAttribute, m as mergeProps, n as useDevtoolsOnClose, f as spread, o as addEventListener, p as untrack, M as Match, F as For, q as Switch, r as onCleanup, v as Show } from "./index-C5XCXy0F.js";
...
const BaseTanStackRouterDevtoolsPanel = function BaseTanStackRouterDevtoolsPanel2({
  ...
  const routerExplorerValue = createMemo(() => Object.fromEntries(multiSortBy(Object.keys(explorerState()), ["state", "routesById", "routesByPath", "options", "manifest"].map((d) => (dd) => dd !== d)).map((key) => [key, explorerState()[key]]).filter((d) => typeof d[1] !== "function" && !["__store", "basepath", "injectedHtml", "subscribers", "latestLoadPromise", "navigateTimeout", "tempLocationKey", "latestLocation", "routeTree", "history"].includes(d[0]))));
...
//# sourceMappingURL=BaseTanStackRouterDevtoolsPanel-Cp4L5Zmg.js.map
